export function Footer() {
  ...
  return (
    <footer className="mt-auto py-8 border-t border-dark-200 dark:border-dark-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-dark-500 dark:text-dark-400">
            <span className="text-xl">🍒</span>
            <span className="text-sm">
              © {currentYear} Cherihub. Todos os direitos reservados.
            </span>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-xs text-dark-500 dark:text-dark-500">
              Hospedado em <span className="font-medium">cherihub.cloud</span>
            </div>
          </div>
        </div>
      </div>
